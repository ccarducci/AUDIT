var ChartsAmcharts = function() {
    ...
    var initChartSample2a = function() {
        
        var chart = AmCharts.makeChart("chart_2a", {
            "type": "serial",
            "theme": "light",
        ...
        $('#chart_2a').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
    
    var initChartSampletop5 = function() {
        
        var chart = AmCharts.makeChart("chart_top5", {
            "type": "serial",
            "theme": "light",
        ...
        $('#chart_top5').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
    
    var initChartSamplecostoMan = function() {
        
        var chart = AmCharts.makeChart("chart_costoMan", {
            "type": "serial",
            "theme": "light",
        ...
        $('#chart_costoMan').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
    
    var initChartSample3a = function() {
        
        var chart = AmCharts.makeChart("chart_3a", {
            "type": "serial",
            "theme": "light",
        ...
        $('#chart_3a').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
