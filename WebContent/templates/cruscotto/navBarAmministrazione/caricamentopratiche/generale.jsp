...
%> 
	<!-- BEGIN CONTENT -->
                    ...
                    <div class="portlet">
				        <div class="row">				        
                            ...
                            <div class="col-lg-6 col-lg-offset-4 col-xs-12">
                                <div class="actions add-action">
                                 ...
                                 <div class="actions add-action">
                                <!-- cruscottoScript.js -->
                                    <a href="#" onclick="getCheckBoxID('modificaCaricamentoPratica');"
                                      class="btn btn-default btn-sm">
                                    <i class="fa fa-pencil"></i> Modifica </a>
                                </div>
                                <div class="actions add-action">
                                <!-- cruscottoscript.js -->
                                     <a data-toggle="modal" onclick="getCheckBoxID('eliminaCaricamentoPratiche');" class="btn btn-default btn-sm del">
                                    <i class="fa fa-trash"></i> Elimina </a>
                                </div>
                                <div class="actions add-action">
                                 <a href="#" onclick="reloadTable('generaleCaricamentoPratiche');"class="btn btn-default btn-sm">
                        ...
                        <div class="portlet-body">
                            <!--<div class="table-scrollable">-->
                                <table class="table table-striped table-bordered table-advance table-hover" id="caricamentopratiche_table">
                                    <thead>
                                        <tr>
           ...
           <div class="modal fade" tabindex="-1" id="deleteCaricamentoPraticheModal" aria-hidden="true">
			  <div class="modal-dialog"  style="width: 500px !important; height: 200px !important;">
			    <div class="modal-content">
			      <div class="modal-header">
			        <div class="caption font-green">
	                    <span class="caption-subject bold uppercase">ELIMINA CARICAMENTO </span>
	                </div>
			      ...
			      <div class="modal-body">
			        <p>Si sta eliminando il caricamento selezionato. Procedere con l' operazione?</p>
			      </div>
			      <div class="modal-footer">
			        <button type="button" data-dismiss="modal" class="btn default">No</button>
			        <!-- generale.js -->
			      <button type="button" class="btn blue" onclick="eliminaCaricamentoPratiche()">Si</button>
			      </div>
			    </div>
			  </div>
			</div>
