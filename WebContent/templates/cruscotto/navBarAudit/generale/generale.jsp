	...
	<!-- BEGIN CONTENT -->
			...
			<div class="page-head">
				...
				<div class="page-title">
					...
					<h1>Generale <!-- <small>- Generale</small> --></h1>
				</div>
...
%>
                            <div class="col-lg-6 col-lg-offset-4 col-xs-12">
                                ...
                                <div class="actions add-action">
                                <!-- cruscottoScript.js -->
                                    <a href="#" onclick="getCheckBoxID('auditGenerale');"
                                      class="btn btn-default btn-sm">
                                    <i class="fa fa-pencil"></i> Modifica </a>
                                </div>
                                <div class="actions add-action">
                                <!-- cruscottoscript.js -->
                                     <a data-toggle="modal" onclick="getCheckBoxID('eliminaAudit');" class="btn btn-default btn-sm del">
                                    <i class="fa fa-trash"></i> Elimina </a>
                                </div>
                                <div class="actions add-action">
                                 <a href="#" onclick="reloadTable('generaleAudit');"class="btn btn-default btn-sm">
...
%>
                            <div class="col-lg-6 col-lg-offset-4 col-xs-12" style="padding-left: 135px;">
								<div class="actions add-action">
                                <!-- cruscottoScript.js -->
                                    <a href="#" onclick="getCheckBoxID('auditGenerale');"
                                      class="btn btn-default btn-sm">
...
%>
                        ...
                        <div class="portlet-body">
                            <!--<div class="table-scrollable">-->
                                <table class="table table-striped table-bordered table-advance table-hover" id="generale_table">
                                    <thead>
                                        <tr>
           ...
           <div class="modal fade" tabindex="-1" id="deleteAuditModal" aria-hidden="true">
			  <div class="modal-dialog"  style="width: 500px !important; height: 200px !important;">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <p>Si stanno eliminando gli audit selezionati. Procedere con l' operazione?</p>
			      </div>
