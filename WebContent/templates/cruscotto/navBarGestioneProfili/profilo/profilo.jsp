	...
	<!-- BEGIN CONTENT -->
			...
			<div class="page-head">
				...
				<div class="page-title">
					...
					<h1>Profilo <!-- <small>- Generale</small> --></h1>
				</div>
                    ...
                    <div class="portlet">
				        <div class="row">				        
                            <div class="col-lg-6 col-lg-offset-4 col-xs-12">
                                <div class="actions add-action">
                                   ...
                                   <a data-toggle="modal" href="#" onclick="slideAsideNew('addProfilo');" class="btn btn-default btn-sm">
                                    <i class="fa fa-plus"></i> Nuovo </a>
                                </div>
                                <div class="actions add-action">
                                <!-- cruscottoScript.js -->
                                    <a href="#" onclick="getUpdateProfilo();"
                        ...
                        <div class="portlet-body">
                            <!--<div class="table-scrollable">-->
                                <table class="table table-striped table-bordered table-advance table-hover" id="profilo_table">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-custom">
            	<s:include value="sideBar/aggiungiProfiloAside.jsp" />			
            	<s:include value="sideBar/modificaProfiloAside.jsp" />			
            </div>
            		
            	<!-- MODALE CONFERMA ELIMINA AREA -->
           <div class="modal fade" tabindex="-1" id="deleteProfiloModal" aria-hidden="true">
			  <div class="modal-dialog"  style="width: 500px !important; height: 200px !important;">
			    <div class="modal-content">
			      <div class="modal-header">
			        <div class="caption font-green">
	                    <span class="caption-subject bold uppercase">ELIMINA PROFILO</span>
	                </div>
			      ...
			      <div class="modal-body">
			        <p>Si sta eliminando il profilo selezionato. Procedere con l' operazione?</p>
			      </div>
			      <div class="modal-footer">
			        <button type="button" data-dismiss="modal" class="btn default">No</button>
			        <!-- generale.js -->
			      <button type="button" class="btn blue" onclick="eliminaAudit()">Si</button>
			      </div>
			    </div>
			  </div>
			</div>
