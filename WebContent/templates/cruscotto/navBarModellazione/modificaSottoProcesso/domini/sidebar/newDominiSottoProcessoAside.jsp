    ...
    <aside class="menu-sx-levelone-facility addDom">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                ...
                <form>
                    <table class="table table-striped table-bordered table-advance table-hover" id="addDominiSottoProcessoTable">
                        <thead>
                            <th>
                            </th>
                            <th>Descrizione</th>
                    ...
                    <div class="form-actions noborder" style="position: relative bottom: 10px;">
                        ...
                        <button type="button" class="btn default" onclick="associaDomToSottoProcesso()">Associa</button>
