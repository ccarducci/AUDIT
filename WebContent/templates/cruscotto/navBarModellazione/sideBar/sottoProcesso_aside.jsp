        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption font-green">
                    ...
                    <span class="caption-subject bold uppercase">NUOVA FASE</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form role="form">
                        ...
                        <div class="row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-medium select2me" id="comboProcesso" name="comboProcesso" />
                                </div>
                            </div>
		                        	...
		                        	<div class="form-group form-md-radios">
											<div class="md-radio-list">	
												<div class="col-md-3 col-xs-6">
													<label for="form_control_2" style="margin-right: 20px;">Stato Fase</label>
                    ...
                    <div class="form-actions noborder" style="position: absolute; bottom: 10px;">
                        <button type="button" class="btn blue" onclick="salvaSottoProcesso('I');">Salva</button>
