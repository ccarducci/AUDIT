        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption font-green">
                    ...
                    <span class="caption-subject bold uppercase">NUOVA ATTIVITA DETTAGLIO</span>
                </div>
            </div>
                ...
                <form role="form">
                    <div class="form-body">
                        <div class="row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-medium select2me" 
                                    		...
                                    		onChange="caricaComboAttivitaComponente();" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="form_control_1" style="top: 0; font-size: 13px; color: #888888; opacity: 1; width: 100%;">Attivita Componente <i class="fa fa-asterisk obbligatorio"></i></label>
                                    <select class="form-control input-medium select2me" 
                               			id="comboAttivitaComponente" 
										name="comboAttivitaComponente" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-actions noborder" style="position: absolute; bottom: 10px;">
                        <button type="button" class="btn blue" onclick="salvaAttivitaDettaglio('I');">Salva</button>
