...
<div class="portlet">
				        ...
				        <div class="row">
                            ...
                            <div class="col-lg-8 col-lg-offset-2 col-xs-12" style="padding-left: 70px;">
                                <div class="actions add-action">
                                    <a data-toggle="modal" onclick="showAsideAllegati()" class="btn btn-default btn-sm">
                                    <i class="fa fa-plus"></i> Aggiungi </a>
                                </div>
                                <div class="actions add-action">
                                    <a data-toggle="modal" onclick="showRemoveModal()" class="btn btn-default btn-sm del">
                                    		...
                                    		<div class="form-group form-md-checkboxes">
                     							<div class="md-checkbox-inline">
                        							<div class="md-checkbox">
                           								<input type="checkbox" id="checkAllAll" class="md-check" onclick="selectAllAll()">
                           									<label for="checkAllAll">
                           										<span></span>
 ...
 <!-- MODAL -->
            <div class="modalAddAllegato">
            	<s:include value="sideBar/addAllegatoDominioAside.jsp" />	
            </div>
	...
	<!-- MODALE CONFERMA ELIMINA DOMINIO -->
  	<div class="modal fade" tabindex="-1" id="deleteAllegatiModal" aria-hidden="true">
	  <div class="modal-dialog"  style="width: 500px !important; height: 200px !important;">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn blue" onclick="eliminaAllegato();">Si</button>
	      </div>
	    </div>
	  </div>
	</div>
