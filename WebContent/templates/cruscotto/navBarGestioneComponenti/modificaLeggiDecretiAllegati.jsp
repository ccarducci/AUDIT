...
<div class="portlet">
                    ...
                    <div class="portlet">
				        <div class="row">
                            ...
                            <div class="col-lg-8 col-lg-offset-2 col-xs-12" style="padding-left: 70px;">
                                ...
                                <div class="actions add-action">
                                    <a data-toggle="modal" onclick="showRemoveModalLeggiDecreti()" class="btn btn-default btn-sm del">
 ...
 <!-- MODAL -->
            <div class="modalAddAllegato">
            	<s:include value="sideBar/addAllegatoLeggiDecretiAside.jsp" />	
            </div>
	...
	<!-- MODALE CONFERMA ELIMINA DOMINIO -->
  	<div class="modal fade" tabindex="-1" id="deleteAllegatiModalLD" aria-hidden="true">
	  <div class="modal-dialog"  style="width: 500px !important; height: 200px !important;">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn blue" onclick="eliminaAllegatoNormativa(4);">Si</button>
	      </div>
	    </div>
	  </div>
	</div>
