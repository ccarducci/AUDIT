var ProcessoNormativaTable = function (numColDate, numColText, numColNumber) {

    var initTable1 = function (numColDate, numColText, numColNumber) {

    	var table = $('#processonormativa_table');
        ...
        var oTable = table.dataTable({
            ...
            "language": {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getProcessoNormativaTable",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
							...
							aoData.push({ "name": "idTipo", "value": idTipo },
										{ "name": "idProcesso", "value": idProcesso });
			           ...
			           "columnDefs": [{   // definisco la prima colonna checkBox assegnandogli id e value
			               ...
			               "mRender" : function(data, type, row) {
								...
								content += '<input type="checkbox"  name="ids" id="checkboxTable_'
										+ row.idDatiTipo
										+ '" class="md-check chkProcessoNormativa" value="'
										+ row.idDatiTipo + '">';
