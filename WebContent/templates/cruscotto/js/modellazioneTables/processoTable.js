var ProcessoTable = function () {

    var initTable1 = function () {
        
    	var table = $('#processo_table');
			...
			"aoColumns" : [
					...
					},
					{
						...
						"mRender" : function(data, type, row) {
							...
							if(data == 'S'){
								var content = '<span>SI</span>';
							}else{
								var content = '<span>NO</span>';
							}
        ...
        var tableWrapper = $('#processo_table_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
