...
var DocAttCompDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiAttCompTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDocumentiMediaAttCompDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDocAttCompAl" value="'+row.id+'">';
