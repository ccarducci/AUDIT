var ComponentiTecniciAttCompTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#compTecniciTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchCompTecniciAttComp",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkCompTecAttComp" value="'+row.idAssociazione+'">';
