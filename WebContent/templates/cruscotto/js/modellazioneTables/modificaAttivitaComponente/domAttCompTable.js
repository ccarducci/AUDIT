...
var DomAttCompTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#dominiAttCompTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDominiAttComp",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDomAttComp" value="'+row.idAssociazione+'">';
