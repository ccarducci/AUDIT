var CompTecAttCompDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#compTecAttCompTableDaAssociare');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchCompTecAttCompDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkCompTecDaAssociare" value="'+row.id+'">';
