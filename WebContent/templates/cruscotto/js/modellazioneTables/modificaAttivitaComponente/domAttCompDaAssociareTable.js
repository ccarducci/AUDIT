var DomAttCompDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#dominiAttCompTableDaAssociare');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDominiAttCompDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDomDaAssociare" value="'+row.id+'">';
