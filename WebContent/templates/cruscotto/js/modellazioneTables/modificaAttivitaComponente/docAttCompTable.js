...
var DocAttCompTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#docMediaAttCompTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDocumentiMediaAttComp",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocAttComp" value="'+row.idAssociazione+"-"+row.idDoc+'">';
