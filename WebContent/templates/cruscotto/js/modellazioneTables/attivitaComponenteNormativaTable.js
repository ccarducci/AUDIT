var ACNormativaTable = function (numColDate, numColText, numColNumber) {

    var initTable1 = function (numColDate, numColText, numColNumber) {

    	var table = $('#acnormativa_table');
        ...
        var oTable = table.dataTable({
            ...
            "language": {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getAttivitaComponenteNormativaTable",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
							...
							aoData.push({ "name": "idTipo", "value": idTipo },
										{ "name": "idAttivitaComponente", "value": idAttivitaComponente });
			           ...
			           "columnDefs": [{   // definisco la prima colonna checkBox assegnandogli id e value
			               ...
			               "mRender" : function(data, type, row) {
								...
								content += '<input type="checkbox"  name="ids" id="checkboxTable_'
										+ row.idDatiTipo
										+ '" class="md-check chkACNormativa" value="'
										+ row.idDatiTipo + '">';
