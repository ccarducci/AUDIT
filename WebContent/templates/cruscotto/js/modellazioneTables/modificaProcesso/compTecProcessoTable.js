var ComponentiTecniciProcessoTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#compTecProcessoTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchCompTecniciProcesso",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkCompTecProcesso" value="'+row.idAssociazione+'">';
		...
		var tableWrapper = $('#compTecProcessoTable_wrapper');
