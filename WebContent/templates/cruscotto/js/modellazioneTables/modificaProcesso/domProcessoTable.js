...
var DomProcessoTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#dominiProcessoTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDominiProcesso",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDomProcesso" value="'+row.idAssociazione+'">';
		...
		var tableWrapper = $('#dominiProcessoTable_wrapper');
