...
var DocProcessoDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiProcessoTable');
		var oTable = table.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDocumentiMediaProcessoDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDocProcessoAl" value="'+row.id+'">';
		...
		var tableWrapper = $('#addAllegatiProcessoTable_wrapper');
