...
var DocProcessoTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#docMediaProcessoTable');
		var oTable = table.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDocumentiMediaProcesso",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocProcesso" value="'+row.idAssociazione+"-"+row.idDoc+'">';
		...
		var tableWrapper = $('#docMediaProcessoTable_wrapper');
