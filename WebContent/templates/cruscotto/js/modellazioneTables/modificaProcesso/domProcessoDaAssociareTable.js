var DomProcessoDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addDominiProcessoTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDominiProcessoDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDomProcessoAl" value="'+row.id+'">';
		...
		var tableWrapper = $('#addDominiProcessoTable_wrapper');
