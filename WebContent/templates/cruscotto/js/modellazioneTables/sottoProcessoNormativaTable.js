var SottoProcessoNormativaTable = function (numColDate, numColText, numColNumber) {

    var initTable1 = function (numColDate, numColText, numColNumber) {

    	var table = $('#sottoprocessonormativa_table');
        ...
        var oTable = table.dataTable({
            ...
            "language": {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getSottoProcessoNormativaTable",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
							...
							aoData.push({ "name": "idTipo", "value": idTipo },
										{ "name": "idSottoProcesso", "value": idSottoProcesso });
			           ...
			           "columnDefs": [{   // definisco la prima colonna checkBox assegnandogli id e value
			               ...
			               "mRender" : function(data, type, row) {
								...
								content += '<input type="checkbox"  name="ids" id="checkboxTable_'
										+ row.idDatiTipo
										+ '" class="md-check chkSottoProcessoNormativa" value="'
										+ row.idDatiTipo + '">';
