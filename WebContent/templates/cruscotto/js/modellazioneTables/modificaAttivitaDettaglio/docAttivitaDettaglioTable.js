...
var DocAttivitaDettaglioTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#docMediaAttivitaDettaglioTable');
		var oTable = table.dataTable( {
					...
					"sAjaxSource" : contextApp + "/jsonATPO/searchDocumentiMediaAttivitaDettaglio",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocAttivitaDettaglio" value="'+row.idAssociazione+"-"+row.idDoc+'">';
		...
		var tableWrapper = $('#docMediaAttivitaDettaglioTable_wrapper');
