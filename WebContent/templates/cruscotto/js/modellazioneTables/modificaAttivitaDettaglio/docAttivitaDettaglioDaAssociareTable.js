...
var DocAttivitaDettaglioDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiAttivitaDettaglioTable');
		var oTable = table.dataTable( {
					...
					"sAjaxSource" : contextApp + "/jsonATPO/searchDocumentiMediaAttivitaDettaglioDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDocAttivitaDettaglioAl" value="'+row.id+'">';
		...
		var tableWrapper = $('#addAllegatiAttivitaDettaglioTable_wrapper');
