var ComponentiTecniciSottoProcessoDaAssociareTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addCompTecSottoProcessoTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : contextApp + "/jsonATPO/searchCompTecniciSottoProcessoDaAssociare",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkCompTecSottoProcessoAl" value="'+row.id+'">';
		...
		var tableWrapper = $('#addCompTecSottoProcessoTable_wrapper');
