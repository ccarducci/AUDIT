...
var DocSottoProcessoTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#docMediaSottoProcessoTable');
		var oTable = table.dataTable( {
					...
					"sAjaxSource" : contextApp + "/jsonATPO/searchDocumentiMediaSottoProcesso",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocSottoProcesso" value="'+row.idAssociazione+"-"+row.idDoc+'">';
		...
		var tableWrapper = $('#docMediaSottoProcessoTable_wrapper');
