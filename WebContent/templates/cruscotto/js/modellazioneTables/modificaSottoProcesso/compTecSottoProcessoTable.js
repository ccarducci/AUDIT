var ComponentiTecniciSottoProcessoTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#compTecSottoProcessoTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : contextApp + "/jsonATPO/searchCompTecniciSottoProcesso",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkCompTecSottoProcesso" value="'+row.idAssociazione+'">';
		...
		var tableWrapper = $('#compTecSottoProcessoTable_wrapper');
