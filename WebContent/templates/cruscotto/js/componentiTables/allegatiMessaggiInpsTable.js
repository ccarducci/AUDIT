...
var AllegatiMessaggiInpsTable = function() {
	
	var initTable1 = function() {
		
		
		var table = $('#allegatiMessaggiInpsTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getAllegatiMessaggiInps",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idTipo", "value": idTipo },
								{ "name": "idMessaggiInps", "value": idMessaggiInps });   // valorizzato se arrivo dal tab Allegati di modificaCircolariInps.
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocMessaggiInps" value="'+row.idAssociazione+"-"+row.idDoc+'">';
