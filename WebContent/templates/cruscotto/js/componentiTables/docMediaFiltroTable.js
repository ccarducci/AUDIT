...
var DocumentiMediaFiltroTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#docMediaTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDocumentiMediaFiltro",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDocM" value="'+row.id+"-"+row.codice.trim()+'">';
