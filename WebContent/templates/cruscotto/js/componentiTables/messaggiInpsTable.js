var MessaggiInpsTable = function () {

    var initTable1 = function () {
        
    	var table = $('#messaggiInpsTable');
        ...
        var oTable = table.dataTable({
            ...
            "sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getMessaggiInpsTable",
			"processing" : false,
			"serverSide" : true,
			...
			"aoColumns" : [
					{
						...
						"mRender" : function(data, type, row) {
							...
							content += '<input type="checkbox"  name="ids" id="checkboxTable_'
									+ row.idMessaggiInps
									+ '" class="md-check chkMessaggiInps" value="'
									+ row.idMessaggiInps + '">';
							content += '<label for="checkboxTable_' + row.idMessaggiInps + '">';
							content += '<span></span>';
        ...
        var tableWrapper = $('#messaggiInpsTable_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
