...
var AddAllegatiNoteDecretiTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiNoteDecretiTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getDocNoAllegatiNoteDecreti",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idNoteDecreti", "value": idNoteDecreti });
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkAllND" value="'+row.id+'">';
