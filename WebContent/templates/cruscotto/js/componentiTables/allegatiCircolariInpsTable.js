...
var AllegatiCircolariInpsTable = function() {
	
	var initTable1 = function() {
		
		
		var table = $('#allegatiCircolariInpsTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getAllegatiCircolariInps",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idTipo", "value": idTipo },
								{ "name": "idCircolariInps", "value": idCircolariInps });   // valorizzato se arrivo dal tab Allegati di modificaCircolariInps.
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocCircolariInps" value="'+row.idAssociazione+"-"+row.idDoc+'">';
