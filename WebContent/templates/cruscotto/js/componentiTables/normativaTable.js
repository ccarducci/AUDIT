var NormativaTable = function (numColDate, numColText, numColNumber) {

    var initTable1 = function (numColDate, numColText, numColNumber) {

    	var table = $('#normativa_table');
    	
    	var colonneDaNascondere = 0;
    	var index = 1;
    	var column = '[';
    	
    	column = column + '{"mData" : null, "bSearchable": false,  "bSortable" : false  },';
        ...
        var oTable = table.dataTable({
            ...
            "language": {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getNormativaTable",
					"processing" : false,
					"serverSide" : true,
			           ...
			           "columnDefs": [{   // definisco la prima colonna checkBox assegnandogli id e value
			               ...
			               "mRender" : function(data, type, row) {
								...
								content += '<input type="checkbox"  name="ids" id="checkboxTable_'
										+ row.idDatiTipo
										+ '" class="md-check chkNormativa" value="'
										+ row.idDatiTipo + '">';
