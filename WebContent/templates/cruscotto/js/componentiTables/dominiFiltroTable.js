...
var DominiFiltroTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#dominiTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchDominiFiltro",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkDom" value="'+row.id+'">';
