...
var AddAllegatiLeggiDecretiTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiLeggiDecretiTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getDocNoAllegatiLeggiDecreti",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idLeggiDecreti", "value": idLeggiDecreti });
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkAllLD" value="'+row.id+'">';
