...
var AddAllegatiMessaggiInpsTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiMessaggiInpsTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getDocNoAllegatiMessaggiInps",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idMessaggiInps", "value": idMessaggiInps });
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkAllMI" value="'+row.id+'">';
