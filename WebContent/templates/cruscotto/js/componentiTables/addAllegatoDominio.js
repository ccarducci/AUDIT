...
var AddAllegatiDominioTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiDominioTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/getDocNoAllegatiAlDominio",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkAllDom" value="'+row.id+'">';
