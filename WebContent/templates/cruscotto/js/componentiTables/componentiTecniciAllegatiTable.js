...
var AllegatiCompTec  = function() {

	var initTable1 = function() {
		
		
		var table = $('#allegatiCompTecTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/jsonATPO/searchAllegatiCompTec",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocCt" value="'+row.idAssociazione+"-"+row.idDoc+'">';
