...
var AddAllegatiCircolariInpsTable = function() {

	var initTable1 = function() {
		
		
		var table = $('#addAllegatiCircolariInpsTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getDocNoAllegatiCircolariInps",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idCircolariInps", "value": idCircolariInps });
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.id+' class="md-check chkAllCI" value="'+row.id+'">';
