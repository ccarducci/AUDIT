...
var NoteDecretiTable = function () {

    var initTable1 = function () {
        
    	var table = $('#noteDecretiTable');
        ...
        var oTable = table.dataTable({
            ...
            "sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getNoteDecretiTable",
			"processing" : false,
			"serverSide" : true,
			...
			"aoColumns" : [
					{
						...
						"mRender" : function(data, type, row) {
							...
							content += '<input type="checkbox"  name="ids" id="checkboxTable_'
									+ row.idNoteDecreti
									+ '" class="md-check chkNoteDecreti" value="'
									+ row.idNoteDecreti + '">';
							content += '<label for="checkboxTable_' + row.idNoteDecreti + '">';
							content += '<span></span>';
        ...
        var tableWrapper = $('#noteDecretiTable_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
