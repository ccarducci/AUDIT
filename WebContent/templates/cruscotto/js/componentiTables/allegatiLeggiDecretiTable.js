...
var AllegatiLeggiDecretiTable = function() {
	
	var initTable1 = function() {
		
		
		var table = $('#allegatiLeggiDecretiTable');
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getAllegatiLeggiDecreti",
					"processing" : false,
					"serverSide" : true,
					"fnServerData": function (sSource, aoData, fnCallback) {
						...
						aoData.push({ "name": "idTipo", "value": idTipo },
								{ "name": "idLeggiDecreti", "value": idLeggiDecreti });   // valorizzato se arrivo dal tab Allegati di modificaCircolariInps.
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id='+row.idAssociazione+' class="md-check chkDocLeggiDecreti" value="'+row.idAssociazione+"-"+row.idDoc+'">';
