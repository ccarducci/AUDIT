...
var EspressRischioTable = function() {

	var initTable1 = function() {
		var table = $('#espressRischioTable');
		...
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/searchRischiEnonConformitaEsprRischio",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									  ...
									  var content='<div class="form-group form-md-checkboxes">';
										...
										content += '<input type="checkbox"  name="chkEspR" id="checkboxT_'
												+ row.idMRisepr 
												+ '" class="md-check chkEspRischio" value="'
												+ row.idMRisepr+'-'+ row.idMRischio+ '-'+row.codiceRischio + '">';
										content += '<label for="checkboxT_' + row.idMRisepr + '">';
										content += '<span></span>';
							...
							{
								"mData" : "percTotaleRischio",
								"bSearchable" : true,
								"bSortable" : true
							}, 
							{
								"mData" : "raggruppamentoRischio",
								"bSearchable" : true,
								"bSortable" : true
							},
							{
