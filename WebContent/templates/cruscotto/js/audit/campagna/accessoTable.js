...
var CampagnaAccessoTable = function() {

	var initTable1 = function() {
		var table = $('#campagnaAccessoTable');
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id="chkAccessoCampagna_'
											+ row.idSessione
											+ '" class="md-check chkAccessoCampagna" value="'
											+ row.idSessione + '">';
									content += '<label for="chkAccessoCampagna_' + row.idSessione + '">';
									content += '<span></span>';
