var CampagnaRegoleTable = function() {

	var initTable1 = function() {
		var table = $('#campagnaRegoleTable');
		...
		var oTable = table
				.dataTable( {
					...
					"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/searchRegole",
					"processing" : false,
					"serverSide" : true,
					...
					"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id="chkRegole_'
											+ row.idRegolaCamp
											+ '" class="md-check chkRegole" value="'
											+ row.idRegolaCamp + '">';
									content += '<label for="chkRegole_' + row.idRegolaCamp + '">';
									content += '<span></span>';
