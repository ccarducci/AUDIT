...
var VerbaliCampione = function() {

	var initTable1 = function() {
		var table = $('#verbaliCampione');
		...
		.dataTable( {
			...
			"language" : {
				"sEmptyTable" : "Nessun verbale associato al Campione",
			...
			"sAjaxSource" : "/CruscottoAuditAtpoWebWeb/json/getVerbaliCampione",
			"processing" : false,
			"serverSide" : true,
			...
			"aoColumns" : [
							{
								...
								"mRender" : function(data, type, row) {
									...
									content += '<input type="checkbox"  name="ids" id="chkSessCamp_'
											...
											+ row.id + '">';
									content += '<label for="chkSessCamp_' + row.id + '">';
									content += '<span></span>';
