...
public class AbstractDataTablesParamUtility {

	private DataTablesModel model;
	private Map<String, Object> parameters;

	public AbstractDataTablesParamUtility(DataTablesModel model,
	...
	public String getStringParameter(String param, Map<String, Object> parametersBody){
		Object[] ret = (Object[]) parametersBody.get(param);
		return (String)ret[0];
	}
	
	public Integer getIntegerParameter(String param, Map<String, Object> parametersBody){
		Object[] ret = (Object[]) parametersBody.get(param);
		return Integer.parseInt((String)ret[0]);
	}
	
	public Boolean getBoolParameter(String param, Map<String, Object> parametersBody){
		Object[] ret = (Object[]) parametersBody.get(param);
