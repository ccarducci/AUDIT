...
public class ModelAuditorsAccessiATPO {
	
	private int filtroEsito;
	...
	private AuSSessioneDto ssessione= new AuSSessioneDto();
	...
	public void setSsessione(AuSSessioneDto ssessione) {
		this.ssessione = ssessione;
	}


	public AuSSessioneDto getSsessione() {
		return ssessione;
	}
	...
	public void setFiltroStato(int filtroStato) {
		this.filtroStato = filtroStato;
	}


	public int getFiltroStato() {
		return filtroStato;
	}


	public void setFiltroEsito(int filtroEsito) {
		this.filtroEsito = filtroEsito;
	}


	public int getFiltroEsito() {
		return filtroEsito;
	}
