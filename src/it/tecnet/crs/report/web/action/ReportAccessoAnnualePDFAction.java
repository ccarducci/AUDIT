...
public class ReportAccessoAnnualePDFAction extends BaseAction implements ModelDriven<ReportPDFBean>{
	...
	public ReportAccessoAnnualePDFAction(ReportPDFService reportPDFService) {
		super();
...
//		}
	...
	public String getReportAccessoAnnualePDF(){
		...
		try {
			...
			report = reportPDFService.getReportAccessoAnnualePDF(idSSessione);
	...
	public String getAllegatoReportAccessoPDFAnnuale(){
		...
		try {
			...
			// Eseguo la query che estrae i dati da visualizzare in stampa
			report = reportPDFService.getAllegatoReportAccessoPDFAnnuale(idSSessione);
			List<AtpoPratiche> objects = reportPDFService.getReportAllegatiPDFAnnuale(report.getSede(),report.getIdSessione());
			// Apro il documento
			document.open();
			// Imposto e implemento il pdf
